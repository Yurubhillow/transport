    ...
    <section class="main-dashboard">
        ...
        <br>
            ...
            <table>
                ...
                <tbody>
                    <?php 
                       $select = mysqli_query($conn,"select * from cargo join pickup on cargo.cargo_id=pickup.cargo_id join staff on staff.staff_id=pickup.staff_id");
                       $counter = 1;
