                    ...
                    <?php 
                       ...
                       while($rowcompany=mysqli_fetch_array($select)){
                        ...
                        <tr>
                            ...
                            <td><?php echo $rowcompany['pick_time'];?> hr</td>
                            <td><?php echo $rowcompany['pick_date'];?></td>
                            <td><?php echo $rowcompany['state_cargo'];?></td>
                            <td>
                                <?php   
                                  $states = $rowcompany['state_cargo'];

                                  if($states == "In progress"){
                                    ?>
                                        <button class="btn btn-success"><a href="delivered.php?cargo_id=<?php echo $cargo_id;?>" style="color:white;text-decoration:none;"> Mark as Delivered </a></button>
                                    <?php
                                  }
                                  else{
                                    ?>
                                         <button class="btn btn-danger"><a href="take.php?cargo_id=<?php echo $cargo_id;?>" style="color:white;text-decoration:none;" onclick="return confirm('Your about to pick cargo for delivery');"> Mark cargo as taken </a></button>
                                  <?php
                                  }
